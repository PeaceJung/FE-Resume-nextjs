const projects = [
  {
    ...
    detail: [
      "WE Studio는 LIVE 스트리밍 서비스입니다. 개별 영상업로드 및 실시간 라이브 스트리밍 기능을 개발했습니다.",
      <br />,
      ...
      <br />,
      "Graphql Subscription을 이용하여 실시간 채팅 기능을 개발했습니다.",
      <br />,
      <br />,
  ...
  },
  {
    ...
    detail: [
      ...
      <br />,
      "Expo를 사용하여 기본 세팅을 진행하였습니다.",
      <br />,
      "Axios를 사용하여 데이터를 불러오고 Redux(LocalStorage)와 State에 저장하여 데이터를 관리했습니다.",
      <br />,
      "결재 검색기능을 개발하였고, SelectBox를 구현하여 다중결재처리 기능도 개발했습니다.",
      <br />,
  ...
  },
  {
    ...
    detail: [
      ...
      <br />,
      "Jitsi App은 오픈소스로 공개되어 있고, 커스터마이징 하여 개발했습니다.",
      <br />,
      ...
      <br />,
      "백그라운드에서는 PIP 모드로 다중작업이 가능하도록 처리했습니다.",
      <br />,
      "사용자 데이터를 유지하고 화면간 데이터를 공유해야하는 부분에서 Redux를 사용하여 데이터를 관리했습니다.",
    ],
